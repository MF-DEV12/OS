      ...
      <?php if($role == "admin"){?>
              <li data-menu="supplier">
                ...
                <ul id="supplierorder" class="collapse sub-menu">
                    <li class="current" data-content="purchaseorder" data-header="Purchase Orders"><a href="#">Purchase Order</a></li>
              ...
              <li data-menu="inventory">
                ...
                <ul id="inventory" class="collapse sub-menu">
                    <li class="current" data-content="inventory" data-header="Inventory"><a href="#">Inventory</a></li>
      ...
      <?php if($role == "supplier"){?>
          ...
          <li>
            ...
            <ul id="sup-items" class="collapse sub-menu">
                <li class="current" data-content="sup-items" data-header="Items"><a href="#">Items</a></li>
