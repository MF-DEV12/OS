    ...
    <?php if($role=="supplier") {?>
        <div class="content-holder">
             <div class="content-group show" data-group="request">
                 <div class="content-list show" data-content="request">
                    <h5 class="dash-header"><span class="glyphicon glyphicon-stats"></span> Request List <subheader></subheader></h5> 
                     <div class="row">
                        <div class="col-md-9">
                        ...
                        <div class="col-md-3">
                            <div class="order-status">
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>Total Orders</h5> 
                                     <?=$requeststatus->All;?>
                                </div>
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>New Orders</h5> 
                                     <?=$requeststatus->New;?>
                                </div>
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>Process Orders</h5> 
                                     <?=$requeststatus->Process;?>
                                </div>
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>Incomplete Orders</h5> 
                                     <?=$requeststatus->Incomplete;?>
                                </div>
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>Shipped Orders</h5> 
                                     <?=$requeststatus->Shipped;?>
                                </div>
                                <div class="col-md-12">
                                     <h5 class="dash-header"></span>Cancelled Orders</h5> 
